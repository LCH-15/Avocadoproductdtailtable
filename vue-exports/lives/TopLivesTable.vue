<template>
  ...
  >
    ...
    <LiveTableRow
      ...
      :key="idx"
      :thumbnail-src="THUMBS[idx]"
      :title="live.title"
      :creator-avatar="AVATARS[idx]"
      :creator-name="live.creator"
      :emoji="live.emoji"
      :units-sold="live.unitsSold"
      :gmv="live.gmv"
      :cumulative-viewers="live.cumulativeViewers"
      :live-duration="live.liveDuration"
      :viewers-peak="live.viewersPeak"
      :start-time="live.startTime"
      :show-divider="idx < LIVES.length - 1"
...
import LiveTableHeader from './LiveTableHeader.vue'
import LiveTableRow from './LiveTableRow.vue'
