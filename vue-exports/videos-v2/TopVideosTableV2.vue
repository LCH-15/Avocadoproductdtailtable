<template>
  ...
  >
    ...
    <V2TableRow
      ...
      :creator-name="video.creator"
      :units-sold="video.unitsSold"
      :gmv="video.gmv"
      :views="video.views"
      :likes="video.likes"
      ...
      :show-divider="idx < VIDEOS.length - 1"
...
import V2TableHeader from './V2TableHeader.vue'
import V2TableRow from './V2TableRow.vue'
